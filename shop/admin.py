...
public_cart, public_reviews, other_products
# Register your models here.
my_models = [product, category, category_front_page, brand, subcategory, rating, review, public_cart, public_reviews, other_products]
